...
class Issue(Document):
	...
	if TYPE_CHECKING:
		from education.education.doctype.student_group_student.student_group_student import StudentGroupStudent
		...
		status: DF.Literal["Abierto", "Le\u00eddo", "Respondido", "Cerrado"]
